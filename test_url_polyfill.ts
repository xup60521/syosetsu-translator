function test(global) {
    ...
    (function (global) {
        ...
        var polyfillURL = function () {
            ...
            var polyfill_URL = function (url, base) {
            ...
            var proto = polyfill_URL.prototype;
            ...
            polyfill_URL.createObjectURL = function (blob) {
                return _URL.createObjectURL.apply(_URL, arguments);
            };

            polyfill_URL.revokeObjectURL = function (url) {
                return _URL.revokeObjectURL.apply(_URL, arguments);
            };

            global.URL = polyfill_URL;
        };
...
const g = {}
test(g);
const polyfill_URL = g.URL;

const url = new polyfill_URL('https://example.com/path?name=value#hash');
console.log(url);